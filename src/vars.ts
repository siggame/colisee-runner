...
export const DOCKER_REGISTRY_HOST: string = _.defaultTo<string>(process.env.DOCKER_REGISTRY_HOST, "");
export const DOCKER_REGISTRY_PORT: number = _.defaultTo<number>(_.toNumber(process.env.DOCKER_REGISTRY_PORT), -1);
